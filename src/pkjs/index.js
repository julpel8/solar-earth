...
function buildLocalConfigHtml(settings) {
  ...
  return [
    ...
    '<section><label>Globe colors</label>',
    '<div class="cc"><span>Day ocean</span><div id="globeDayOcean" class="swatches"></div></div>',
    '<div class="cc"><span>Day land</span><div id="globeDayLand" class="swatches"></div></div>',
    '<div class="cc"><span>Night ocean</span><div id="globeNightOcean" class="swatches"></div></div>',
    '<div class="cc"><span>Night land</span><div id="globeNightLand" class="swatches"></div></div>',
    '<div class="cc"><span>City lights</span><div id="globeCity" class="swatches"></div></div></section>',
    ...
    'var globeDayOceanState=buildSwatches("globeDayOcean",settings.SETTING_GLOBE_DAY_OCEAN);',
    'var globeDayLandState=buildSwatches("globeDayLand",settings.SETTING_GLOBE_DAY_LAND);',
    'var globeNightOceanState=buildSwatches("globeNightOcean",settings.SETTING_GLOBE_NIGHT_OCEAN);',
    'var globeNightLandState=buildSwatches("globeNightLand",settings.SETTING_GLOBE_NIGHT_LAND);',
    'var globeCityState=buildSwatches("globeCity",settings.SETTING_GLOBE_CITY);',
    ...
    'settings.SETTING_GLOBE_DAY_OCEAN=hex(globeDayOceanState.value);',
    'settings.SETTING_GLOBE_DAY_LAND=hex(globeDayLandState.value);',
    'settings.SETTING_GLOBE_NIGHT_OCEAN=hex(globeNightOceanState.value);',
    'settings.SETTING_GLOBE_NIGHT_LAND=hex(globeNightLandState.value);',
    'settings.SETTING_GLOBE_CITY=hex(globeCityState.value);',
